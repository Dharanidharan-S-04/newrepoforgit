...
# Partner certificate from IntermediateCA
...
openssl x509 -req -extensions usr_cert -extfile ./openssl.cnf -days 1000 -in Partner.csr -CA IntermediateCA.crt -CAkey IntermediateCA.key -set_serial 04 -out Partner.crt
openssl verify -CAfile RootCA.crt -untrusted IntermediateCA.crt Partner.crt
openssl pkcs8 -topk8 -inform PEM -outform PEM -nocrypt -in Partner.key -out Partner.key.pkcs8